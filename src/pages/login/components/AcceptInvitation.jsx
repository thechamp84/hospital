...
import { Form, Input, Button, Card, Row, Divider, Select, Col, message } from 'antd';
import { history } from 'umi';
import { acceptCompanyInvitation } from '../service';
...
const acceptInvitation = (props) => {
  ...
  const onFinish = async (values) => {
    ...
    const result = await acceptCompanyInvitation(data)
      .then((res) => {
        if (res.success) {
